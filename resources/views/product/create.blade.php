...
<body>
    ...
    <div class="container bg-white">
        <div class="row">
            <div class="col-md-12">
                <h1 class="text-center">Form Produksi</h1>
                <hr>
                <form action="{{ route('products.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama_kelola_produk') is-invalid @enderror" id="nama_kelola_produk" name="nama_kelola_produk" value="{{ old('nama_kelola_produk') }}">
